...
public class TicketSearch {
    public List<Ticket> searchTicketsDeveloper(ArrayList<Milestone> milestones, JsonNode filters, String username, ArrayList<Ticket> inventarTichete, ArrayList<Users> useri) {
                ...
                if (assignedDev[j].equals(username)) {
                    ...
                    for (int k = 0 ;  k < tickets.length; k++) {
                        ...
                        if (t.getStatus().equals("OPEN")) {
                            if (businessPriority != null && !t.getBusinessPriority().equals(businessPriority) ) {
                                continue;
                            }
                            ...
                            if (t.isAvailableForAssignment() != availableForAssignment && filters.get("availableForAssignment") != null) {
                                continue;
                            }
                            if (t.isAvailableForAssignment() == availableForAssignment && filters.get("availableForAssignment") != null) {
    ...
    public List<Ticket> searchTicketsManager(JsonNode filters, ArrayList<Ticket> inventarTichete) {
        List<Ticket> tichete =  new LinkedList<>();
        String businessPriority = null;
        String type = null;
        String createdAt = null;
